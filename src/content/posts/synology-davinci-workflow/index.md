...
- **位置:** 你的 NAS IP，这里就是`10.4.7.2` （注意：只支持纯 IP或纯 域名，**绝对不能加 `:5432` 端口号**，否则必报未知主机错误！）
...
一套“元数据上云、原片在 NAS、代理在本地”的高效剪辑流就此打通。这套流程解决了个人硬盘空间不足的痛点，同时让多人协作调色、加特效成为了现实。接下来，博主就要开始策划、拍摄、s剪片了，尽请期待吧！