...
首先，**用电脑浏览器**打开[https://payments.google.com](https://payments.google.com) ，打开后应该是需要你的验证，此时只要你如 1.2 所说**掌握全部验证渠道**，那肯定是能通过的。
...
另外一定要注意：你添加的卡只是支付方式，有支付资料就必须有一种支付方式，但是支付资料和支付方式并非一一对应！所以单纯的删卡并不能解除 Play 商店地区的固定，必须关闭支付资料。我们也可以在不删卡的前提下通过添加和修改使用的支付资料来换区。这就是