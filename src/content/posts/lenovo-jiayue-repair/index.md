...
或许是 VT8237A 这一代南桥的默认操作，又或许是联想 BIOS 默认把 SATA 硬盘模拟成 IDE 硬盘工作（Legacy IDE Emulation）。好处是 XP 这种老系统免驱，但代价极其惨重：IDE 模拟模式不支持 NCQ（原生指令排序）等高级特性。
没有了 NCQ，新硬盘 4K 扇区不对齐带来的额外“读-改-写”惩罚被无限放大，机械寻道效率极低。这就解释了为什么当年不仅花屏，启动过程还伴随着硬盘极其痛苦的疯狂寻道声。