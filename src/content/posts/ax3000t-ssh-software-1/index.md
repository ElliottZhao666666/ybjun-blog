...
不过，既然要在家里作为主路由，需要兼顾稳定性和米家生态，那么刷 OpenWRT 自然不是一个理想选择。所以我们就要在原厂系统的基础上实现自定义内容的加入，**这无异于“带着镣铐跳舞”**，不仅要和极其局促的闪存空间做斗争，还要应付小米系统各种奇奇怪怪的底层重置机制。这套“软化硬路由”的方案耗费了博主不少精力，期间踩的坑也是不计其数。
