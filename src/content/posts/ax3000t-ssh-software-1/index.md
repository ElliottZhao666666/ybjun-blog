...
前段时间，博主淘到了一台小米 AX3000T 路由器，原本想着直接替换家里那台服役五年多 AC2350，但极客DNA动了，寻思着先在手边“浅浅”折腾一下。

不查不知道，一查确实有点小惊喜 —— **作为一款搭载联发科平台的小米路由，它的魔改和刷机空间竟然非常可观！**
![img_1782637689922.png](./img_1782637689922.png)

既然如此，博主就来在拿回家正式服役前，给它来一场改造。本来博主已经想给家里单独挂个晶晨机顶盒了，既然这玩意可玩性还不错，那不如试试**软化一下硬路由**？

不过，要想在保留原厂系统的同时实现自定义的内容加入，**无异于“带着镣铐跳舞”**，不仅要和极其局促的闪存空间做斗争，还要应付小米系统各种奇奇怪怪的底层重置机制。这套“软化硬路由”的方案耗费了博主不少精力，期间踩的坑也是不计其数。

今天，月半菌就来和大家硬核复盘一下这台 AX3000T 的折腾全记录，希望能给各位同好提供一些实用的参考！
